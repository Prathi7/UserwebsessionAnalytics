...
class Solution(object):
    ...
    def run(self):
        ...
        with open("inactivity_period.txt","r") as iptxt:#Read i/p .txt file
            session_duration=datetime.timedelta(seconds=int(iptxt.read()))#Convert to time format
            
        optxt=open("sessionation.txt","w+")#create o/p .txt file
        
        with open("log1.csv", "r") as f:#Read each line of i/p .csv file
